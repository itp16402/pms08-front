...
@Component({
  selector: 'app-acceptance-second-step',
  templateUrl: './acceptance-second-step.component.html',
  styleUrls: ['./acceptance-second-step.component.scss']
})
export class AcceptanceSecondStepComponent implements OnInit, AfterViewInit {
